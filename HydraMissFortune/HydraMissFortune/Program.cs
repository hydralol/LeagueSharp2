...
using HydraMissFortune;

namespace HydraMissFortune
{
	class Program
	{
		...
		private static void Game_OnGameLoad(EventArgs args)
		{
            ...
            Menu = new Menu("H MissFortune", "HydraMissFortune_" + ObjectManager.Player.ChampionName, true);
			...
			try
			{
                var handle = System.Activator.CreateInstance(null, "HydraMissFortune." + ObjectManager.Player.ChampionName);
