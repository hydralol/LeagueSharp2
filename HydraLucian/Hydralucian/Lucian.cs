...
namespace Hydralucian
{
	class Lucian : Champion
	{
		...
		private void LoadMenu()
		{
            ...
            Program.Menu.SubMenu("Combo").AddItem(new MenuItem("useQ_TeamFight", "Use Q").SetValue(true));
            Program.Menu.SubMenu("Combo").AddItem(new MenuItem("useW_TeamFight", "Use W").SetValue(true));
            Program.Menu.SubMenu("Combo").AddItem(new MenuItem("useE_TeamFight", "Use E").SetValue(true));
            Program.Menu.SubMenu("Combo").AddItem(new MenuItem("useE_TeamFight_Range", "E Target in Range").SetValue(new Slider(1100, 2000, 500)));
            Program.Menu.SubMenu("Combo").AddItem(new MenuItem("useR_TeamFight", "Use R").SetValue(false));
			Program.Menu.SubMenu("Combo").AddItem(new MenuItem("useR_TeamFight_2", "Use R if rest on CD").SetValue(true));
